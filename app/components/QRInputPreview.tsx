...
export function QRInputPreview() {
  return (
    <div className="flex flex-col items-center gap-4">
      <label htmlFor="website-url" className="text-sm font-medium text-gray-700 self-start mb-1">
      ...
      <input
        ...
        disabled
      />
      <span className="text-sm text-gray-500 mt-2 self-start">Live Preview</span>
